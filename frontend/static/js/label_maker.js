...
import { combineHexColors, getRelativeLuminance, hexToRgbA } from './color_helpers.js';
            ...
            for (const block of page.blocks) {
                ...
                for (const definition of labelDefinitions) {
                    ...
                    if (definition.type === 'classification_single' || definition.type === 'classification_multiple') {
                        ...
                        const button = textLabeler.addTextLabelButton(definition.name, definition.color, definition.type, false);
