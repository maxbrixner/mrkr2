...
export class RemoteListPopup extends HTMLElement {
    contentUrl = undefined;
    idField = undefined;
    displayField = undefined;
    _modular = document.createElement('dialog');
    _content = document.createElement('fieldset');
    ...
    _populateShadowRoot() {
        ...
        this._content.textContent = "Content goes here";
