...
with sdk.MrkrClient(log_level="DEBUG") as client:
    ...
    if not any(x.name == "Local Demo Project 2" for x in projects):
        project_id = client.create_project(
            name="Local Demo Project 2",
            config={
                "label_definitions": [
                    {
                        "type": "classification_multiple",
    ...
    if not any(x.name == "Local Demo Project 3" for x in projects):
        project_id = client.create_project(
            name="Local Demo Project 3",
            config={
                "label_definitions": [
                    {
                        "type": "text",
    ...
    if not any(x.name == "Local Demo Project 4" for x in projects):
        project_id = client.create_project(
            name="Local Demo Project 4",
            config={
                "label_definitions": [
                    {
                        "type": "classification_single",
